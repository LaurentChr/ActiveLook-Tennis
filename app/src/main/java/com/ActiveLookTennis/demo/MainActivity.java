...
public class MainActivity extends AppCompatActivity {
        ...
        clockRunnable = new Runnable() {
            ...
            public void run() {
                if (connectedGlasses != null) {
                    ...
                    connectedGlasses.battery(r1 -> connectedGlasses.layoutDisplay((byte)  7, String.format("%d", r1)));//GLasses Battery
                    String clock = sdf.format(new Date());
                    connectedGlasses.layoutDisplay((byte) 0x0A,clock);//Time
    ...
    private void updateVisibility() {
        ...
        if (g == null) {
            ...
            g.cfgSet("ALooK");
            g.battery(r1 -> g.layoutDisplay((byte)  7, String.format("%d", r1)));//GLasses Battery
            String clock = sdf.format(new Date());
            g.layoutDisplay((byte) 0x0A,clock);//Time
